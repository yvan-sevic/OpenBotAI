...
void CBot::ExecuteCommand()
{
	...
	if (!RunMimicCommand(botCmd))
	{
		...
		botCmd.impulse     = 0;
		// Normal bots: viewangles were integrated in CCSBot::UpdateLookAngles() into pev->v_angle.
		// Do not add aim/look logic here; keep motor output and command submission separate.
