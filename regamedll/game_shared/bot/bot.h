...
public:
	...
	// Pending movement/attack buttons accumulated before ExecuteCommand (diagnostics only).
	unsigned short GetPendingBotButtonFlags() const { return m_buttonFlags; }
...
protected:
	virtual void PostBotThinkAfterUpdate() {}
