...
void EXT_FUNC CBasePlayer::__API_HOOK(PostThink)()
{
	...
	// Log human grenade throw intent before weapons mutate inventory (edge + active grenade).
	AimLog::RecordHumanGrenadeThrowIfAny(this);
	// do weapon stuff
	ItemPostFrame();
	AimLog::RecordHumanSample(this);
	AimLog::RecordHumanRoamSample(this);
